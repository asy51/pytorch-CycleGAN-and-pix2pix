...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--val_epoch_freq', type=int, default=3, help='frequency of running validation at the end of epochs')
        parser.add_argument('--img_epoch_freq', type=int, default=1, help='frequency of logging images at the end of epochs')
